  ...
  <section id="comments">
	...
	<ul class="pagination">
	  <?php if (get_previous_comments_link()) : ?>	
	    <li class="arrow"><?php previous_comments_link(__('&larr; Older comments', 'roots')); ?></li>
	  <?php endif; ?>
	  <?php if (get_next_comments_link()) : ?>
	    <li class="arrow"><?php next_comments_link(__('Newer comments &rarr;', 'roots')); ?></li>
	  <?php endif; ?>
	</ul>
	</nav>
  ...
  <section id="respond">
    ...
    <?php else : ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <p><input name="submit" class="small button" type="submit" id="submit" value="<?php _e('Submit Comment', 'roots'); ?>"></p>
